...
const OneClickIntegrationsIllustration: React.FC<OneClickIntegrationsIllustrationProps> = ({ className = "" }) => {
  const themeColors = {
    ...
    gradientLightGrayStart: "hsl(var(--foreground) / 0.2)",
    gradientLightGrayEnd: "transparent",
  }
  ...
  const LogoBox: React.FC<{
    ...
    if (isGradientBg) {
      boxStyle.background = `linear-gradient(180deg, ${themeColors.gradientLightGrayStart} 0%, ${themeColors.gradientLightGrayEnd} 100%)`
      boxStyle.boxShadow = `0px 1px 2px ${themeColors.shadowColor}`
  ...
  const VSCodeLogo = (
    <svg width="36" height="38" viewBox="0 0 36 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        ...
        >
          <stop stopColor={themeColors.primaryColor} />
          <stop offset="1" stopColor={themeColors.primaryColor} />
        </linearGradient>
        <linearGradient
