      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-8 rounded-2xl border border-primary/20">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-1 leading-snug">조회수 3배<br/>무한 콘텐츠 생성</h3>
            <p className="text-muted-foreground mb-4 leading-snug">상품 분석부터 광고 집행<br/>고객 관리까지 완전 자동화</p>
          ...
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-8 rounded-2xl border border-primary/20">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-1 leading-snug">매출 300% 만드는<br/>마케팅 프로세스</h3>
            <p className="text-muted-foreground mb-4 leading-snug">타겟 고객 발굴부터 예약 유도까지 자동화된<br/>마케팅 퍼널</p>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
          ...
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-8 rounded-2xl border border-primary/20">
            ...
            <h3 className="text-2xl font-bold text-foreground mb-1 leading-snug">평균 문의량 10배 증가<br/>신규 고객 확보</h3>
            <p className="text-muted-foreground mb-4 leading-snug">브랜드 맞춤 콘텐츠 생성부터<br/>SNS 업로드까지 완전 자동화</p>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
